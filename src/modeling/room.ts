...
export function buildRoom(roomNumber: number, swapSign = false, isIncludeDetails = false) {
  ...
  4, [materials.greenPlasterWall, materials.greenPlasterWall, materials.greenPlasterWall, materials.greenPlasterWall, materials.greenPlasterWall, materials.wallpaper]);
  const testWall2 = buildSegmentedWall([23], 12, [12], [], 1, 4, [materials.wallpaper, materials.wallpaper, materials.wallpaper, materials.wallpaper, materials.wallpaper, materials.greenPlasterWall]);
  const testWall3 = buildSegmentedWall([34], 12, [12], [], 1, 4, [materials.wallpaper, materials.wallpaper, materials.wallpaper, materials.wallpaper, materials.wallpaper, materials.greenPlasterWall]);
